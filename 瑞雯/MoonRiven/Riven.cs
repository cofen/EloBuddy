namespace MoonRiven
{
    ...
    internal class Riven : Logic
    {
        ...
        {
            //Draw the Chat
            Chat.Print("Moon" + Player.Instance.ChampionName + ": Load Success! EloBuddy.cn", System.Drawing.Color.LightSteelBlue);
			Chat.Print("Get the best script from : www.EloBuddy.cn");
